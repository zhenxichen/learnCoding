...
public class LeetCode1116 {
    ...
    private static void testSemaphore() {
        ZeroEvenOddSemaphore s = new ZeroEvenOddSemaphore(6);
        new Thread(() -> {
            try {
                s.zero(System.out::print);
    ...
    private static void testLock() {
        ZeroEvenOddLock s = new ZeroEvenOddLock(6);
        new Thread(() -> {
            try {
                s.zero(System.out::print);
            } catch (InterruptedException e) {
